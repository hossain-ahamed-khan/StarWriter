                        ...
                        <div data-aos="fade-up-right">
                            <div className={styles["whychoose-card"] + " p-2"}>
                                <div className={styles["whychoose-card"] + " p-4"}>
                                    ...
                                    <h2 className="text-xl sm:text-2xl font-bold my-4">Natural Wording Variation</h2>
                                    <p className="text-xs sm:text-sm pb-1">Our AI humanizer rewrites text in a natural way, breaking AI patterns while keeping the original meaning, making the content undetectable by AI detection tools.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div data-aos="fade-up-left">
                            <div className={styles["whychoose-card"] + " p-2"}>
                                <div className={styles["whychoose-card"] + " p-4"}>
                                    ...
                                    <p className="text-xs sm:text-sm pb-1">Processes thousands of words in seconds with our optimized AI humanizing technology, saving you time and effort.</p>
                                </div>
                            </div>
                        </div>
                    </div>
