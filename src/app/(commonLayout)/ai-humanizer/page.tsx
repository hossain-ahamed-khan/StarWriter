    ...
    return (
        <div className={`py-8 ${theme === 'light' ? 'bg-white text-black' : 'bg-[#010006] text-white'}`}>
            <div className="w-full lg:w-3/5 mx-auto text-center">
                <h1 className='text-2xl md:text-4xl font-bold'>Humanize Your Text & Make it Undetectable</h1>
                <p className='text-xs md:text-lg'>Type your text below, and watch it transform into a more natural, human-like version.</p>
            </div>
