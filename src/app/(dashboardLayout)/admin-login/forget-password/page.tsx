...
const ForgetPasswordPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push(`/admin-login/forget-password/set-otp?email=${encodeURIComponent(email)}`);
        } catch (error: any) {
            ...
            <div className="w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                    ...
                    <div className="text-center mt-4">
                        <Link href="/admin-login" className="text-sm text-purple-400 hover:text-purple-300 transition-colors">
                            ← Back to Login
                        </Link>
                    </div>
                </form>
